...
app.use(function (req, res, next) {  // is use ka fayada ya hai ki aap ka koi bhi route chlne sei pehle yei chleiga and ikse baad kaam hone ke liye hume  next ka use krna pdeiga taki agei wala kaam ho 
